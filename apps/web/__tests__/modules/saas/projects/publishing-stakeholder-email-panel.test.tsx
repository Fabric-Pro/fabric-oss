 ...
 */
describe("StakeholderEmailPanel — reviewing a refinement proposal", () => {
	const PROPOSED = "Builds are faster. Here is what changed.";
	const SAVED = new Date("2026-09-01T12:00:00Z");

	const saved = {
		postType: "STAKEHOLDER_EMAIL" as const,
		hasBody: true,
		body: "Builds are faster, and here is what changed.",
		sourceDraftId: "d1",
		sourceOptionLabel: null,
		sourceContent: null,
		updatedAt: SAVED,
