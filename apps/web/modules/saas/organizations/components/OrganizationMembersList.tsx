				...
				return (
					<div className="flex flex-row justify-end gap-2">
						{userIsOrganizationAdmin ? (
							<>
								{/*
								 * Owner-target rows and the "owner" option in the dropdown
								 * are restricted to existing org owners. Non-owners cannot
								 * edit owner rows and cannot pick the owner role (Better
								 * Auth would reject the call anyway).
								 */}
