...
const PROJECT_GROUP: GsGroup = {
	...
	items: [
		...
		},
		{
			...
			href: projectHref("coding-instructions"),
		},
		{
			id: "roadmap",
			label: "Roadmap",
...
export const GET_STARTED_PAGES: readonly GsPage[] = [
		...
		components: [
			{
				...
				body: "Not a vanity score — it tracks how many of the six core planning docs are complete. When this bar fills, the AI finally has enough to build from.",
			},
			{
				id: "overview-metrics",
			...
			},
			{
				...
				body: "The six artifacts a project needs before build — PRD, tech spec, frontend, backend, security, implementation plan. Each gap here is a document you can create from the Documents tab.",
			},
		],
	},
	{
	...
	},
	{
		...
		components: [
			{
				id: "coding-instructions-tree",
				anchor: "coding-instructions-tree",
				title: "Browse in original paths",
				body: "The published snapshot's skills, agents, rules and setup files, grouped exactly as they sit in your .claude folder. The search box filters by path, name, and frontmatter description at once.",
				conditional: true,
			},
			{
				id: "coding-instructions-file-view",
				anchor: "coding-instructions-file-view",
				title: "Frontmatter becomes a real header",
				body: "Selecting a skill or agent file turns its name, description, allowed tools, and model-invocation setting into a readable header, with the Markdown body rendered underneath.",
				conditional: true,
			},
			{
	...
	},
	{
		...
		components: [
			...
			},
			{
				...
				body: "Not just a name — it scaffolds the full workspace: documents, roadmap, agents, code map, reports. (A 'workspace', by contrast, is just a document knowledge base.) This is the real starting move in Fabric.",
			},
		],
	},
	{
