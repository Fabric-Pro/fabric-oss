...
export interface UserStory {
	...
	/** The recommendation batch an `ai_recommended` item was accepted from. */
	aiRecommendationBatchId?: string | null;
	/** Set once a person protects the item from batch removal. */
	aiBatchProtectedAt?: string | Date | null;
...
export function transformStory(
	...
	return {
		...
		aiRecommendationBatchId: story.aiRecommendationBatchId ?? null,
		aiBatchProtectedAt: story.aiBatchProtectedAt ?? null,
