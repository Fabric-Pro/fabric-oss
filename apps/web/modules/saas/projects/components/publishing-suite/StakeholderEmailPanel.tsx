			...
			{canEdit ? (
				<>
					...
					<div className="flex flex-wrap items-center gap-3">
						 ...
						 * rebuilds the stakeholder email from the planning analysis; this one revises the
						...
						{refineInFlight ? (
							<output className="flex items-center gap-2 text-muted-foreground text-sm">
								<Loader2Icon
									...
									aria-hidden="true"
								/>
								Revising your saved stakeholder email…
							</output>
						) : null}
					...
					<p className="text-muted-foreground text-xs leading-relaxed">
						Refine with AI is what edits this stakeholder email —
						the AI Assistant works on the planning analysis, not on
						drafts.
					</p>
				</>
			) : (
								...
								>
									...
									>
										<p className="text-muted-foreground text-xs leading-relaxed">
											...
											compare against. The stakeholder
											email you have saved is not affected
											until you adopt it.
										</p>
										{guidanceField}
										<Button
