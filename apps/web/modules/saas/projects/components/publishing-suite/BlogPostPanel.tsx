...
export function BlogPostPanel({
	...
	const refinement = useDraftRefinement({
		...
		confirmAccept: () =>
			!isDirty ||
			window.confirm(
				"Saving the refined blog post discards your unsaved edits. Continue?",
			),
		...
		<section className="space-y-2">
			...
			{canEdit ? (
				<>
							...
							>
								<div className="space-y-1">
									...
									<p className="text-muted-foreground text-xs leading-relaxed">
										...
										result comes back as a proposed revision
										of that text, shown as a diff you accept
										or discard — it does not make a new
										version, and nothing you have saved
					...
					<p className="text-muted-foreground text-xs leading-relaxed">
						Refine with AI is what edits this blog post — the AI
