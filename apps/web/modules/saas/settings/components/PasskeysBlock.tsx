...
export function PasskeysBlock() {
	...
	const addPasskey = async () => {
		// Handle the resolved result rather than fetchOptions callbacks:
		// browser-side failures (cancelled dialog, authenticator without user
		// verification) are caught inside the passkey client and resolve as
		// `{ data: null, error }` without ever invoking `onError`.
