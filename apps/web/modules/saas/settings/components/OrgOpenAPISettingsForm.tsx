...
export function OrgOpenAPISettingsForm() {
	...
	const { data: services, isLoading } = useQuery({
		queryKey: ["openapi-services", "org", organizationId],
		queryFn: async () =>
			organizationId
				? await orpcClient.openapi.services.list({ organizationId })
				: [],
	...
	const onboardMutation = useMutation({
		mutationFn: async (input: {
			...
			authValue?: string;
			authLocation?: string;
		}) => await orpcClient.openapi.services.onboard(input as any),
		onSuccess: () => {
	...
	return (
		<TooltipProvider>
			<SettingsItem
				title="OpenAPI Services"
				description="Connect external APIs for your organization by providing their OpenAPI specification URL"
			>
...
function OrgToolConfigDialog({
	...
	const { data: tools, isLoading } = useQuery({
		queryKey: ["openapi-tools", service?.id, organizationId],
		queryFn: async () =>
			service
