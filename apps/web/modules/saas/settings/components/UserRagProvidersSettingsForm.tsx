...
export function UserRagProvidersSettingsForm() {
	...
	const { data: providerConfigs = [], isLoading: isLoadingConfigs } =
		useQuery({
			queryKey: ["userRagProviders"],
			queryFn: async () => {
				return await orpcClient.ragProviders.getUserProviders();
			},
		});
	...
	const updateMutation = useMutation({
		mutationFn: async (data: {
			...
			return await orpcClient.ragProviders.updateUserProvider({
	...
	return (
		<>
			<SettingsItem
				title="Personal RAG Extraction Providers"
				description="Configure your personal document extraction providers. These settings override organization-level configurations."
			>
						...
						<div className="flex gap-3">
							...
							<div className="space-y-1 text-sm">
								...
								<p className="text-muted-foreground">
									Your personal provider configurations will
									override organization settings. This allows
									you to use your own API keys for document
									extraction.
								</p>
							</div>
						</div>
