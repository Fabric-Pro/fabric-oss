 ...
 * Agent Chat Page
 *
 * CopilotKit-based chat interface for document generator agents.
...
export default function AgentChatPage() {
	...
	// Check if this is a CUGA agent by checking the agent's registered agentId
	// The URL param (agentId) might be a database ID, but agent.agentId is the registered name
