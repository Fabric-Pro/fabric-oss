/**
 * Token exchange endpoint for the fabric-kanban CLI.
 * Accepts plain JSON { token } and returns the launch context.
 * Calls verifyKanbanLaunchToken directly to avoid a self-referential HTTP roundtrip
 * through the oRPC adapter (which was causing 500 errors).
 */
