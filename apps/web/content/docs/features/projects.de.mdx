...
- **Duplikate entfernen** — Ein Element mit demselben Inhalt wie ein anderes ist als *Duplikat von …* markiert; **Duplikate entfernen** löscht die zusätzlichen Kopien und behält das Original
- **Living Memory** — Dateien, die ein verbundener Agent aus einem Arbeitsverzeichnis überträgt, erscheinen unter *Living Memory*, nach Ordner gruppiert und mit dem vollständigen Pfad unter dem Dateinamen
