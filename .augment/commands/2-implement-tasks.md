...
> **Usage**: Reference with `.augment/commands/2-implement-tasks.md` or copy into chat

---

## Workflow Instructions

Now that you have the task group(s) to be implemented, proceed with implementation following the `.augment/rules/implementer.md` guidelines.
...
NEXT STEP 👉 Run .augment/commands/3-verify-implementation.md to verify the implementation.
```
