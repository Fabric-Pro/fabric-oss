...
> **Usage**: Reference with `.augment/commands/improve-skills.md` or copy into chat
...
All of the Skills in our project are located in `.augment/skills/` (if available). Each Skill has its own folder and inside each Skill folder is a file called `SKILL.md`.
...
```
Before I proceed with improving your Skills, can you confirm that you want me to revise and improve ALL Skills in your skills folder?
...
Analyze and read each skill file to understand:
- What it is
