...
> **Usage**: Reference with `.augment/commands/4-create-tech-stack.md` or copy into chat
...
NEXT STEPS 👉 
- Run .augment/commands/shape-spec.md to start a new feature
- Run .augment/commands/write-spec.md if you already have requirements
```
