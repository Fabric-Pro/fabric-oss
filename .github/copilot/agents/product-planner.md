...
**When to Use**: Reference this agent with `@.github/copilot/agents/product-planner.md` in Copilot Chat
...
3. **Database**: PostgreSQL, MongoDB, MySQL, Cosmos DB?
...
for file in mission.md roadmap.md; do
    if [ ! -f "fabric/product/$file" ]; then
        echo "Error: Missing $file"
    else
        echo "✓ Created fabric/product/$file"
    fi
done

echo "Product planning complete! Review your product documentation in fabric/product/"
```
