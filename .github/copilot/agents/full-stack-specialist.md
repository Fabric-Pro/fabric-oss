...
**When to Use**: Reference this agent with `@.github/copilot/agents/full-stack-specialist.md` in Copilot Chat
...
- **Database**: PostgreSQL, MongoDB, Cosmos DB, schema design, query optimization
