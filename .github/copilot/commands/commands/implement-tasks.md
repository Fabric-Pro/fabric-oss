...
- Path to spec: `fabric/specs/[this-spec]/spec.md`
- Path to requirements: `fabric/specs/[this-spec]/planning/requirements.md`
- Path to visuals: `fabric/specs/[this-spec]/planning/visuals/` (if exists)
...
- spec: fabric/specs/[this-spec]/spec.md
- requirements: fabric/specs/[this-spec]/planning/requirements.md
- visuals: fabric/specs/[this-spec]/planning/visuals/ (if exists)
...
5. Mark tasks complete with [x] in fabric/specs/[this-spec]/tasks.md
...
1. **"all"** → Include all files from `fabric/standards/global/`, `frontend/`, `backend/`, `infrastructure/`
2. **"global/*"** → Include all `.md` files from `fabric/standards/global/`
3. **"frontend/components.md"** → Include `fabric/standards/frontend/components.md`
...
1. Create `fabric/specs/[this-spec]/implementation/coordinator-prompt.md`:
   ```markdown
   ...
   2. For EACH task group:
      ...
      g. Mark tasks in fabric/specs/[this-spec]/tasks.md with [x]
   ...
   - spec: fabric/specs/[this-spec]/spec.md
   - requirements: fabric/specs/[this-spec]/planning/requirements.md
   - visuals: fabric/specs/[this-spec]/planning/visuals/
   - tasks: fabric/specs/[this-spec]/tasks.md
   
   ## Standards
   
   [List standards from orchestration.yml or fabric/standards/]
...
1. Delegate to the **implementer** subagent with:
   - The specific task group from `fabric/specs/[this-spec]/tasks.md`
   - Path to spec: `fabric/specs/[this-spec]/spec.md`
   - Path to requirements: `fabric/specs/[this-spec]/planning/requirements.md`
   - Path to visuals: `fabric/specs/[this-spec]/planning/visuals`
...
- The path to this spec: `fabric/specs/[this-spec]`
Instruct the subagent to do the following:
  1. Run all of its final verifications according to its built-in workflow
  2. Produce the final verification report in `fabric/specs/[this-spec]/verifications/final-verification.md`.
