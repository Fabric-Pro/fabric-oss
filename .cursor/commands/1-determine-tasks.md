...
> **Usage**: Reference with `@.cursor/commands/1-determine-tasks.md` or copy into chat
...
**If the user HAS provided instructions:** Proceed to PHASE 2 to delegate implementation of those specified task group(s) to the **implementer** agent using `@.cursor/rules/implementer.mdc`.
...
NEXT STEP 👉 Run @.cursor/commands/2-implement-tasks.md
```
