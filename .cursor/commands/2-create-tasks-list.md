...
> **Usage**: Reference with `@.cursor/commands/2-create-tasks-list.md` or copy into chat
...
## Task Group 1: [Name]
**Dependencies**: None
**Specialist**: @.cursor/rules/backend-specialist.mdc
**Complexity**: S/M/L
...
**Specialist**: @.cursor/rules/frontend-specialist.mdc
**Complexity**: M
...
```
ℹ️ No project standards found. Consider running @.cursor/prompts/standards-shaper.md to establish conventions.
```
...
NEXT STEP 👉 Run:
- @.cursor/prompts/implement-tasks.md (simple, effective)
- @.cursor/prompts/orchestrate-tasks.md (advanced, powerful)
```
