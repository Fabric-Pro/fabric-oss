...
- `fabric/specs/[this-spec]/spec.md` (if present)
- `fabric/specs/[this-spec]/planning/requirements.md` (if present)
- `fabric/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `fabric/specs/[this-spec]/tasks.md`
