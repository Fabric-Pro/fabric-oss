 ...
 * Pydantic AI Adapter
 *
 * Adapter for Pydantic AI (Python) agents.
 * Supports:
...
export interface PydanticAIAdapterConfig {
	/** Agent identifier */
	name: string;
 ...
 * Pydantic AI Adapter
 *
 * Wraps Pydantic AI agents to provide:
 * - Framework-agnostic access
 * - CopilotKit integration
 * - AG-UI protocol compliance
 */
export class PydanticAIAdapter<TState extends BaseAgentState = BaseAgentState>
	implements CopilotKitAgentAdapter<TState>
{
	readonly name: string;
	readonly framework = "pydantic_ai";
	...
	constructor(config: PydanticAIAdapterConfig) {
		...
		console.log("[PydanticAIAdapter] Initializing adapter:", {
			name: this.name,
	 ...
	 * Pydantic AI agents expose a CopilotKit-compatible HTTP endpoint
	 */
