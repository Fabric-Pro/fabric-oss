...
async function applyRLS() {
	...
	try {
		...
		const tables = [
			...
			{
				name: "publishing_topic_analysis_revision",
				policy: "user_owned",
			}, // Publishing Suite user-owned analysis prose
			{
				name: "publishing_topic_draft_revision",
				policy: "user_owned",
			}, // Publishing Suite user-owned draft prose history
