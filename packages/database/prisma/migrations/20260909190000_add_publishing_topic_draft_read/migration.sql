...
CREATE TABLE "publishing_topic_draft_read" (
    ...
    -- "PublishingTopicPostType", NOT the snake_case name. This enum has no
    -- `@@map` in the schema, so Prisma created it PascalCase in
    -- 20260716120000 and nothing has renamed it since — the same literal every
    -- other table using it spells, including `publishing_topic_draft`.
