// Mirrors `apps/web/modules/saas/projects/lib/__tests__/append-attachments-section.test.ts`.
// Both suites assert the same idempotent-append contract — see spec § 8.2 / Task 1.5.
...
describe("appendAttachmentsSection (server-side mirror)", () => {
	...
	it("inserts the block ABOVE a trailing HTML 'View in Fabric' back-link", () => {
		...
		// Images come before the back-link.
