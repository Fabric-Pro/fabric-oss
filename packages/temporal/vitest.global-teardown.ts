...
export default function setup() {
	return async () => {
		// process.exit() forces shutdown after a grace period (vitest's
		// teardownTimeout fails to override). Aggressive but it's the
		// only thing that reliably escapes when handles linger.
