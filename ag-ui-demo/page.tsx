				...
				{isMobile ? (
					<>
						...
						<div className="fixed bottom-0 left-0 right-0 z-50">
							<div className="bg-gradient-to-t from-white via-white to-transparent h-6" />
							<div
						...
						>
							...
							>
								<div className="w-12 h-1 bg-gray-400 rounded-full hover:bg-gray-500 transition-colors" />
							</div>
...
function diffPartialText(oldText: string, newText: string, isComplete = false) {
